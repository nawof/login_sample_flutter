...
class MyProgreessBar extends StatefulWidget {
  ...
  @override
  State<MyProgreessBar> createState() => _MyProgreessBarState();
}

class _MyProgreessBarState extends State<MyProgreessBar> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(MyProgreessBar old) {
    triggerAnimation();
